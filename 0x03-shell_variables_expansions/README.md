File: 0-alias Create a script that creates an alias. Name: ls and Value: rm *
...
File: 6-create_local_variable Create a script that creates a new local variable. Name: BEST and Value: School

File: 7-create_global_variable Create a script that creates a new global variable. Name: BEST and Value: School
